...
Create these seven entries in each environment's Bitwarden project. Values are
...
1. Create all seven Bitwarden entries per environment and commit their UUID
